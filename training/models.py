...
class VideoEncoder(nn.Module):
    def __init__(self):
        ...
        self.backbone.fc = nn.Sequential( #run these layers in sequence
...
class MultimodalTrainer:
    def __init__(self, model, train_loader, val_loader):
        ...
        base_dir = '/opt/ml/output/tensorboard' if 'SM_MODEL_DIR' in os.environ else 'runs' #Am I currently running inside SageMaker, or on my own machine (like a laptop or Colab
        ...
        self.optimizer = torch.optim.Adam([
            {'params': model.text_encoder.parameters(), 'lr': 8e-6}, #learning rate
